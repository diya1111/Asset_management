...
while($row=mysql_fetch_array($result1))
{
	...
	echo "<td>  ".$e."</td>";
	echo "<td>  ".$f."</td>";
	 echo "<td><font color='red'>".$g."</font></td>";
	echo "<td><a href='complaintadmin2.php?uid=$b'id='td'>Manage</a></td>";
	$sql="select * from complaints where status='Pending'";
		...
		// else
		// {
		// 	echo "<td><font color='Red'>Pending</font></td>";
		// }
		
// if($flag1==1)echo "<td><font color='Green'>Done</font></td>";
// else echo "<td><font color='Red'>Pending</font></td>";
