...
$sql1="INSERT INTO assetIssue(aid,uid,uname,noa,status) VALUES($aid,$uid,'$uname',$noa,'$status')";
    $result1=mysql_query($sql1,$con);
//echo "$sql1";
//exit();
if($result1)
	{
		echo "<h3>Insertion Succesful</h3>";
...
echo "<table>";
echo "<tr>";
echo "<th>Isssue no.</th>";
echo "<th>Asset Id</th>";
echo "<th>Member Id</th>";
echo "<th>No of Assigned Assets</th>";
...
$sql3="update assets set availability = availability-$noa where aid = $aid";
  $result3=mysql_query($sql3,$con);

  //$sql4="insert into eXdate(uid,today_date,future_date) values($c,now(),date_add(now(),interval 30 day))";
  //$result4=mysql_query($sql4,$con);
}
else{
	echo "<h3>Operation Unsuccesful";
}

echo "<div id='b1'>";
	echo "<div id='back1'><a href='issueview.php' id='back'>Back</a></div>";
	echo "</div>";
