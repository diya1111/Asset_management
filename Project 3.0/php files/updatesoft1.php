...
<html>
<head>
	<script src="find_software.js"> </script>
<style>
#container {
	width:100%;
	height:600px;
...
<ul>
	...
	<li><hr></li>
	<li id="l1"><span>&#9783;</span>&nbsp&nbsp&nbsp&nbsp<a href="software.php">Softwares</a></li>
	<li><hr></li>
...
<form action="updatesoft2.php" method="POST" onsubmit="return formValidation()">
<div id="rt1">
<table>
	<tr>
		<th colspan="2">Update Software assets</th></tr>
		<tr>
		<td>Asset ID : </td>
		<td><input type="text" name="aid" id="text" onKeyUp="showUser(this.value);"/></td>
	</tr>

<tr>
		<td>Asset Name : </td>
		<td><input type="text" name="aname" id="text"> </td>
	</tr>

<tr>
		<td>Date : </td>
		<td><input type="date" name="adop" id="text" placeholder="Date"></td>
	</tr>
...
$con=mysql_connect("localhost","root","");
$db=mysql_select_db("atpl",$con);
$sql="select * from assets where atype='software'";
$result=mysql_query($sql,$con); 
	//echo "$sql";
	//exit();
...
echo "<tr>";
		echo "<td>Category : </td>";
		echo "<td><input readonly type='text' name='atype' id='text' value='$a'></td>";
	echo "</tr>";
?>
<tr>
		<td>Availability : </td>
		<td><input type="text" name="availability" id="text" placeholder="No."></td>
	</tr>

<td>Amount : </td>
		<td><input type="text" name="original_cost" id="text"></td>
	</tr>
<tr>
		<td colspan=2 id="pos"><input type="submit" value="Submit" action="updatesoft2.php" id="btn"></td>
	</tr>
</table>
<div id="txtHint" align="center"> <b> </b>
<div id='b1'>
<div id='back1'><a href='software.php' id='back'>Back</a></div>
	</div>
<div id="new"><p></div>
</div>
</div>
