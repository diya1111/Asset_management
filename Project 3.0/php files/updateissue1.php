...
<table>
	<tr>
		<th colspan="2">Update Issue List</th></tr>
		<tr>
		<td>Asset ID : </td>
...
<tr>
		<td>User ID : </td>
		<td><input type="text" name="uid" id="text"></td>
	</tr>
...
<tr>
		<td>Date of Issue : </td>
		<td><input type="date" name="date_issue" id="text" placeholder="Email"></td>
	</tr>
 
<tr>
		<td>Status : </td>
		<td><input type="text" name="status" id="text"></td>
	</tr>

<tr>
		<td colspan=2 id="pos"><input type="submit" value="Submit" action="updateissue2.php" id="btn"></td>
	</tr>
</table>
