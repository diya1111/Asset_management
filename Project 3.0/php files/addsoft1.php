...
<form action="addsoft2.php" method="POST" onsubmit="return formValidation()">
<div id="rt1"><table>
	<tr>
		<th colspan="2">Add new Software</th></tr>
	<tr>
		<td>Asset Name : </td>
...
<tr>
		<td colspan=2 id="pos"><input type="submit" value="Submit" action="addsoft2.php" id="btn"></td>
	</tr>
</table>
