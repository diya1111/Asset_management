...
<html>
<head>
	<script src="find_hardware.js"> </script>
<style>
#container {
	width:100%;
	height:600px;
...
<ul>
	...
	<li><hr></li>
	<li  id="l1"><span>&#10066;</span>&nbsp&nbsp&nbsp&nbsp<a href="hardware.php">Hardwares</a></li>
	<li><hr></li>
...
<form action="updatehard2.php" method="POST" onsubmit="return formValidation()">
<div id="rt1">
<table>
	<tr>
		<th colspan="2">Update Hardware assets</th></tr>
		<tr>
		<td>Asset ID : </td>
...
$con=mysql_connect("localhost","root","");
$db=mysql_select_db("atpl",$con);
$sql="select * from assets where atype='hardware'";
$result=mysql_query($sql,$con); 
	//echo "$sql";
	//exit();
...
<tr>
		<td colspan=2 id="pos"><input type="submit" value="Submit" action="updatehard2.php" id="btn"></td>
	</tr>
</table>
<div id="txtHint" align="center"> <b> </b>
<div id='b1'>
<div id='back1'><a href='hardware.php' id='back'>Back</a></div>
	</div>
<div id="new"><p></div>
</div>
</div>
