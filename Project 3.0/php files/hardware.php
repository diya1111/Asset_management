...
<form action="delhard1.php" method="POST" onsubmit="return formValidation()">
<div id="rt1">
<?php
...
while($row=mysql_fetch_array($result))
{
	...
	echo "<td>  ".$d."</td>";
	echo "<td>  ".$e."</td>";
	echo "<td><a href='delhard1.php?aid=$a'id='td'>Delete Asset</a></td>";
...
echo "</tr>";
	...
	echo "<br>";
	echo "<div id='b1'>";
	echo "<div id='back1'><br>>>&nbsp&nbsp<a href='addhard1.php' id='back'>Add Hardware ?</a><hr>>>&nbsp&nbsp<a href='updatehard1.php' id='back'>Update Assets(Hardware)?</a></div>";
	echo "</div>";
?>
