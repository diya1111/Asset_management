...
$sql="delete from assets where aid='$a' ";
$result=mysql_query($sql,$conn);
//echo "$sql"; 
	
if($result)
{
	echo "<h3>Asset is Deleted successfully";
}
...
echo "</tr>";
	...
	{
	echo " <h3>Delete failed ";
	echo " <br> <a href='feedback.php'>Try again</a>";
	}

	echo "<br>";
	echo "<br>";
	echo "<div id='b1'>";
	echo "<div id='back1'><a href='hardware.php' id='back'>Delete Another?</a></div>";
	echo "</div>";
?>
