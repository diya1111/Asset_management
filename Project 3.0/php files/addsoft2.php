...
$sql="INSERT INTO assets(aname,adop,atype,availability,original_cost) VALUES('$aname','$adop','$atype',$availability,$original_cost)";
$result=mysql_query($sql,$conn);
//echo "$sql"; 
	
if($result)
{
	echo "<h3>Asset is Added successfully";
}
$sql1="select * from assets where atype='software'";
...
echo "</tr>";
	...
	//echo " <br> <a href='software.php'>Try again</a>";
	}

	echo "<br>";
	echo "<br>";
	echo "<div id='b1'>";
	echo "<div id='back1'><a href='addsoft1.php' id='back'>Add Another?</a></div>";
	echo "</div>";
?>
