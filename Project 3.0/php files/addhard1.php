...
function doChk()
{        
var anam=document.f1.aname.value;
var adopo=document.f1.adop.value;
if(anam =="" || adopo =="")
{
alert("Name or date field is blank");
return false;
}
else{
 alert("On process");
...
<form action="addhard2.php" method="POST" onsubmit="doChk()">
<div id="rt1"><table>
	<tr>
		<th colspan="2">Add new hardware</th></tr>
	<tr>
		<td>Asset Name : </td>
		<td><input type="text" name="aname" id="text" placeholder="Name"></td>
	</tr>

<tr>
		<td>Date of Purchase : </td>
		<td><input type="date" name="adop" id="text" placeholder="Name"></td>
	</tr>

<tr>
		<td> Category : </td>
		<td><select id="text" name="atype">
			<option></option>
	 	<?php

$con=mysql_connect("localhost","root","");
$db=mysql_select_db("atpl",$con);
$sql="select distinct atype from assets";
...
?></td>
	...
	<tr>
		<td>Availability : </td>
		<td><input type="text" name="availability" id="text"></td>
	</tr>
...
<tr>
		<td colspan=2 id="pos"><input type="submit" value="Submit" action="addhard2.php" id="btn"></td>
	</tr>
</table>
