...
$sql="update assetIssue set status='Withdrawn' where aid=$aid and uid=$uid";
...
$sql="update assets set availability = availability+$nop where aid=$aid";
$result=mysql_query($sql,$conn);
//echo "$sql";
//exit();
	}
else{
	echo "<h3>Operation Unsuccessful";
}
?>
<div id='b1'>
<div id='back1'><a href='withdraw1.php' id='back'>Withdraw Another?</a></div>
	</div>
<div id="new"><p></div>
</div>
</div>
