...
<table>
	<tr>
		<th colspan="2">Add new member</th></tr>
	<tr>
...
<tr>
		...
		<td><input type="text" name="pwd" id="text" placeholder="Password"></td>
	</tr>

<tr>
		<td> Email : </td>
		<td><input type="text" name="email" id="text" placeholder="Email"></td>
	</tr>

<tr>
		<td> Usertype : </td>
		<td><select id="text" name="utype">
			<option></option>
	 	<?php
...
?></td>
	...
	<tr>
		<td>Phone no. : </td>
		<td><input type="text" name="phone" id="text"></td>
	</tr>

<tr>
		<td>ADD Photo : </td>
		<td><input type="file" name="photo" id="text"></td>
	</tr>

<tr>
		<td colspan=2 id="pos"><input type="submit" value="Submit" action="memadd2.php" id="btn"></td>
	</tr>
</table>
<div id="new"><p></div>
</div>
