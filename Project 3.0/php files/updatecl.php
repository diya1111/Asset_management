...
<table>
	<tr>
		...
		<td><input type="text" placeholder="New password" name="pwd" id="text"></td>
	</tr>

	<tr>
		<td>Update Phone no.</td>
		<td><input type="text" placeholder="Phone" name="phone" id="text"></td>
	</tr>

	<tr>
		<td>Change Photo</td>
		<td><input type="file" value="Upload Photo" name="photo" id="text"></td>
	</tr>

<tr>
  <td colspan=2><input type="submit" id="btn" value="Submit" action="updatecl2.php"></td>
</tr>
