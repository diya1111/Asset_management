...
while($row=mysql_fetch_array($result))
{
	...
	echo "<td>  ".$d."</td>";
	echo "<td>  ".$e."</td>";
	echo "<td><a href='delsoft.php?aid=$a'id='td'>Delete Asset</a></td>";
...
echo "</tr>";
	...
	echo "<br>";
	echo "<div id='b1'>";
	echo "<div id='back1'><br><a href='addsoft1.php' id='back'>Add Software ?</a><hr><a href='updatesoft1.php' id='back'>Update Assets(Software)?</a></div>";
	echo "</div>";
?>
