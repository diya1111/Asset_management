...
<form action="delsoft.php" method="POST" onsubmit="return formValidation()">
<div id="rt1">
<?php
$aid=$_POST['aid'];
$adop=$_POST['adop'];
...
$sql="update assets set adop='$adop',availability=$availability,original_cost=$cost where aid=$aid ";
...
$sql2="select * from assets where aid=$aid";
...
echo "</tr>";
	...
	echo "<h3>Operation Unsuccessful</h3>";
	echo "<br><br><br><a href='updatesoft1.php'>Try Again</a>";
}
	//echo "<br>";
	echo "<br>";
