...
<ul>
	...
	<li><hr></li>
	<li id="l1"><span>&#9998;</span>&nbsp&nbsp&nbsp&nbsp<a href="complaintadmin.php">Complaints<?php if($flag==1) echo "<font color='red'>*</font>";?></a></li>
	<li><hr></li>
...
<form action="addhard2.php" method="POST" onsubmit="return formValidation()">
<div id="rt1">
...
$sql2="update complaints set status='Done' where uid=$a";
mysql_query($sql2,$con); 
$sql="update assetIssue set status='On_process' where uid=$a";
$result=mysql_query($sql,$conn);
//echo "$sql";
//exit();
if($result)
{
	echo "<br><br><h1>Continue</h1>";
	echo "<br><a href='updateissue1.php'>Updating?</a>";
}
else{
	echo "</h3>Operation Unsuccessful</h3>";
	echo "<h2><a href='complaintadmin'>Try Again</a>";
}
?>
<div id="new"><p></div>
</div>
