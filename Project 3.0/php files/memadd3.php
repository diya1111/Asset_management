...
<ul>
	...
	<li><hr></li>
	<li id="l1"><span>&#9791;</span>&nbsp&nbsp&nbsp&nbsp<a href="memadd.php">Add members</a></li>
	<li><hr></li>
...
{
	echo "<br><h3> Unsuccessful Operation, email id already exists";
	echo "<br><a href='memadd.php'>Try again</a>";
}
else{
$sql="insert into user_table VALUES ($uid,'$uname','$pwd','$email', '$utype', '$phone','$pic') ";
...
while($row=mysql_fetch_array($result1))
{
	...
	echo "<td>  ".$f."</td>";
	echo "<td>  ".$g."</td>";
	echo "<td><a href='delsoft.php?aid=$a'id='td'>Delete</a></td>";
	

echo "</tr>";
}
echo "<h3> <a href='memadd.php'>Add another</a></h3>";

}
}
else
	{
		echo "<script>alert('MemberID exists already');
          </script>";
	echo " <br><br><h3><u>Operation failed</u>";
	echo " <br><br> <a href='memadd.php'>Try again</a>";
	}
}
